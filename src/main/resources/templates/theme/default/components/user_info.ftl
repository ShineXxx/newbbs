<div class="card">
    ...
    <div class="card-footer pt-2 pb-2" style="background-color: #cccfff; font-size: 14px;">
<#--        <div class="row">-->
<#--            <span class="col-md-6"><a href="/notifications"><span id="n_count">0</span> 条未读消息</a></span>-->
<#--&lt;#&ndash;            <span class="col-md-6 text-right">积分：<a href="/top100">${_user.score!0}</a></span>&ndash;&gt;-->
<#--        </div>-->
    </div>
